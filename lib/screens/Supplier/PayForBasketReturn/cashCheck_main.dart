...
import 'package:vansale/screens/Supplier/PayForBasketReturn/cashCheck_components_BkReturn.dart';
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: ListView(children: [BodyCashCheckPay_BkReturn()]),
              ),
            ],
          ),
        ),
                    ...
                    if (GlobalParam.deliveryCashCheck['checkDate'] == '') {
                      ...
                      if (GlobalParam.deliveryPayReq.iDEBIT == 0) {
                        ...
                        var datas = PayReq(
                            ...
                            iCREDIT: (double.tryParse(
                                        GlobalParam.deliveryStoreSum.iTOTAL!) ??
                                    0.0) -
