...
import 'package:vansale/screens/Supplier/PayForBasketReturn/cashTransfer_components_bkReturn.dart';
...
class CashTransfer extends StatefulWidget {
  ...
  CashTransfer(this.navigated);

  @override
  _CashTransferState createState() => _CashTransferState();
}
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              // ),
              Expanded(
                child: ListView(children: [Body_CashTransfer_BkReturn()]),
              ),
            ],
          ),
        ),
      ...
      child: TextButton(
        onPressed: () async {
          ...
          var datas = PayReq(
              ...
              iDEBIT: GlobalParam.deliveryPayReq.iDEBIT,
              iCREDIT: (double.tryParse(GlobalParam.deliveryStoreSum.iTOTAL) ??
                      0.0) -
              ...
              cCQCD: "",
              cCQDT: "");
          print(GlobalParam.deliveryPayReq.iDEBIT);
          print(datas.toJson());
          payMent(datas);
          widget.navigated();
        },
