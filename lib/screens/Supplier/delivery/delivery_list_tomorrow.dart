...
class DeliveryListTomorow extends StatefulWidget {
  //const DeliveryListTomorow({ Key? key }) : super(key: key);
  final String typeMenuCode;
  DeliveryListTomorow(this.typeMenuCode);
  @override
  _DeliveryListTomorowState createState() => _DeliveryListTomorowState();
}

class _DeliveryListTomorowState extends State<DeliveryListTomorow> {
