...
import 'package:vansale/screens/Supplier/shipping/shipping_store_detail.dart';

class SupShipping extends StatefulWidget {
  //const Shipping({ Key? key }) : super(key: key);
  final String typeMenuCode;
  SupShipping(this.typeMenuCode);

  @override
  _SupShippingState createState() => _SupShippingState();
}

class _SupShippingState extends State<SupShipping> {
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: 
                      // Container()
                      GridMenuStore(widget.typeMenuCode),
                    ),
                  ),
                  Container(
                    alignment: Alignment.center,
