...
import 'package:vansale/screens/Supplier/supplier/widgets/basketCard.dart';

class Baskets extends StatefulWidget {
  final String typeMenuCode;
  Baskets(this.typeMenuCode);
...
class _BasketsState extends State<Baskets> {
  List<OrderBranchModel> virtualOrder = [
    OrderBranchModel(
        ...
        branchName: "AAAAAAAAAAAAAAAAAAAAAAAA",
        amount: 25680.00),
    OrderBranchModel(
        id: 2,
        date: DateTime.now().toIso8601String(),
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        ...
                        child: BasketCard(orderBranch: virtualOrder[index]),
                      );
                    }),
              ),
            ),
