...
import 'package:vansale/screens/Supplier/supplier/widgets/badProductCheckCard.dart';

DelayTime delay = new DelayTime();

class GetBadProductsCheck extends StatefulWidget {
  final String typeMenuCode;
  final int order_id;
  final VoidCallback navigated;
  GetBadProductsCheck(this.typeMenuCode, this.order_id, this.navigated);
  @override
  _GetBadProductsCheckState createState() => _GetBadProductsCheckState();
}

class _GetBadProductsCheckState extends State<GetBadProductsCheck> {
          ...
          children: [
            ...
            TextButton(
                onPressed: () {
                  ...
                  // Navigator.of(context).push(MaterialPageRoute(
                  //     builder: (comtext) =>
                  //         ConfirmPages("T008", "รับสินค้าชำรุด")));
