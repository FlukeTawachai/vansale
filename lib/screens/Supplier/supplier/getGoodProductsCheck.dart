...
class GetGoodProductsCheck extends StatefulWidget {
  final String typeMenuCode;
  final int orderId;
  final VoidCallback navigated;
  GetGoodProductsCheck(this.typeMenuCode, this.orderId, this.navigated);
  @override
  _GetGoodProductsCheckState createState() => _GetGoodProductsCheckState();
}

class _GetGoodProductsCheckState extends State<GetGoodProductsCheck> {
