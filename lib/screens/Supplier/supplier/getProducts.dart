...
import 'package:vansale/screens/Supplier/supplier/widgets/productCard.dart';

class GetProducts extends StatefulWidget {
  final String typeMenuCode;
  GetProducts(this.typeMenuCode);
...
class _GetProductsState extends State<GetProducts> {
  List<OrderBranchModel> virtualOrder = [
    OrderBranchModel(
        ...
        branchName: "AAAAAAAAAAAAAAAAAAAAAAAAAAAA",
        amount: 25680.00),
    OrderBranchModel(
        id: 2,
        date: DateTime.now().toIso8601String(),
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        ...
                        child: ProductCard(orderBranch: virtualOrder[index]),
                      );
                    }),
              ),
            ),
