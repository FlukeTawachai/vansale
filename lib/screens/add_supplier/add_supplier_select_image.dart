...
class AddSupplierSelectImage extends StatefulWidget {
  final String typeMenuCode;
  AddSupplierSelectImage(this.typeMenuCode);

  @override
  State<AddSupplierSelectImage> createState() => _AddSupplierSelectImageState();
}
