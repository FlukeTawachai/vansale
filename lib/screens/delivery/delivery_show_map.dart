...
class DeliveryShowMap extends StatefulWidget {
  final String typeMenuCode;
  DeliveryShowMap(this.typeMenuCode);

  @override
  State<DeliveryShowMap> createState() => _DeliveryShowMapState();
}

class _DeliveryShowMapState extends State<DeliveryShowMap> {
