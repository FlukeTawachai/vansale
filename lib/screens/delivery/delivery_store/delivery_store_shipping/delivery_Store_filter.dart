        ...
        child: InkWell(
          onTap: () {
            ...
            if (widget.pageNumber != '003') {
              List<GetHisProductResp> typeF = [];
              List<GetHisProductResp> catF = [];
              List<GetHisProductResp> subCatF = [];
              List<GetHisProductResp> braF = [];
              if (typeCodeNum != '') {
                ...
                for (int i = 0;
                    ...
                    i++) {
                  if (GlobalParam.deliveryHisProduct[i].cTYPE == typeCodeNum) {
                    GlobalParam.deliveryShowHisProduct
                        .add(GlobalParam.deliveryHisProduct[i]);
                  ...
                  for (int i = 0;
                    ...
                    for (int j = 0; j < catF.length; j++) {
                      if (GlobalParam.deliveryHisProduct[i].cPRODCD ==
                              catF[j].cPRODCD &&
                          GlobalParam.deliveryShowHisProduct.length <
                              GlobalParam.deliveryHisProduct.length) {
                        // print(catF[j].cPRODNM );
                        GlobalParam.deliveryShowHisProduct
                            .add(GlobalParam.deliveryHisProduct[i]);
                      }
                    ...
                    for (int i = 0;
                      ...
                      for (int j = 0; j < subCatF.length; j++) {
                        if (subCatF[j].cPRODCD ==
                                GlobalParam.deliveryHisProduct[i].cPRODCD &&
                            GlobalParam.deliveryShowHisProduct.length <
                                GlobalParam.deliveryHisProduct.length) {
                          GlobalParam.deliveryShowHisProduct
                              .add(GlobalParam.deliveryHisProduct[i]);
            ...
            // print(brandCodeList);
            // for (int j = 0; j < GlobalParam.deliveryHisProduct.length; j++) {
            //   print(GlobalParam.deliveryHisProduct[j].cPRODNM);
            // }
            // print(
            //     '${GlobalParam.deliveryShowHisProduct.length} :: ${GlobalParam.deliveryHisProduct.length}');
