...
class SaleCheckIn extends StatefulWidget {
  final String code;
  final bool openMap;
  final GetSaleStoreOrderResp store;
  SaleCheckIn(this.openMap, this.code, this.store);
  //const StartWork({ Key? key }) : super(key: key);

  @override
  _SaleCheckInState createState() => _SaleCheckInState();
}

class _SaleCheckInState extends State<SaleCheckIn> {
