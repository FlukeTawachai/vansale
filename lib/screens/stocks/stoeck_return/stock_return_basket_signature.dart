...
class StockBasketReturnSignature extends StatefulWidget {
  ...
  @override
  State<StockBasketReturnSignature> createState() =>
      _StockBasketReturnSignatureState();
}

class _StockBasketReturnSignatureState
    extends State<StockBasketReturnSignature> {
  // initialize the signature controller
  GetSupplierResp receiver = GetSupplierResp();
    ...
    try {
      ...
      if (result.isNotEmpty) {
        for (int i = 0; i < result.length; i++) {
          if (result[i].cSUPCD == widget.cVEHICD) {
            setState(() {
              receiver = result[i];
            });
          }
