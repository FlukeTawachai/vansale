...
class StockReturnMissPro extends StatefulWidget {
  //const MoreItem({ Key? key }) : super(key: key);
  final String typeMenuCode;
  final bool reset;
  StockReturnMissPro(this.typeMenuCode, this.reset);
  @override
  _StockReturnMissProState createState() => _StockReturnMissProState();
}

class _StockReturnMissProState extends State<StockReturnMissPro> {
                    ...
                    child: Card(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) =>
                                  CustomerOrderFilterPage(pageNumber: '002')));
                        },
                        child: Container(
